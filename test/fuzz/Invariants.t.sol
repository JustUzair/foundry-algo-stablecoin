...
contract Invariants is StdInvariant, Test {
    ...
    function setUp() public {
        ...
        handler = new Handler(dsce, dsc, ERC20Mock(collateralTokens[0]), ERC20Mock(collateralTokens[1]));
        targetContract(address(handler));
    }

    function invariant_protocolMustHaveMoreValueThatTotalSupplyDollars() public view {
        uint256 totalSupply = DecentralizedStableCoin(dsc).totalSupply();
        ...
        console.log("timesMintDSCCalled: %s", handler.timesMintDSCCalled());
